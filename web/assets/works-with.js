...
const PLATFORMS = [
  ...
  ['Semantic Kernel',      'http', 'as a plugin'],
  ['Haystack',             'http', 'as a tool'],
  ['DSPy',                 'http', 'as a tool'],
  ['Agno',                 'http', 'as a tool'],
  ['smolagents',           'http', 'as a tool'],
  ['Letta',                'http', 'as a tool'],
  ['Dify',                 'http', 'HTTP node'],
  ['Flowise',              'http', 'HTTP node'],
  ['Langflow',             'http', 'API request component'],
  ['Temporal',             'http', 'inside an activity'],
  ['Inngest',              'http', 'inside a step'],
  ['Trigger.dev',          'http', 'inside a task'],
  ['Airflow',              'http', 'HttpOperator'],
  ['Prefect',              'http', 'inside a task'],
  ['Dagster',              'http', 'inside an op'],
  ...
  ['OpenRouter',    'model', ''],
  ['Hugging Face',  'model', 'Inference Endpoints'],
  ['Replicate',     'model', ''],
  ['DeepInfra',     'model', ''],
  ['Cerebras',      'model', ''],
  ['xAI',           'model', ''],
